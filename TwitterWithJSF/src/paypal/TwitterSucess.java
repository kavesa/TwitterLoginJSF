...
public class TwitterSucess {

	public TwitterResult getPayPal(HttpServletRequest request) {
		TwitterResult ppr = new TwitterResult();
		TwitterConfig pc = new TwitterConfig();
